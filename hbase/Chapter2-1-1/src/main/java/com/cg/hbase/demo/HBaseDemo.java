...
public class HBaseDemo {  
    ...
    protected static Connection hTablePool = null;
    public static void init() {  
        conf = HBaseConfiguration.create();  
        conf.set("hbase.zookeeper.quorum", "namenode22,datanode23");  
    ...
    public static void addData(String rowKey, String tableName,  
        ...
        Table table = hTablePool.getTable(TableName.valueOf(tableName));//new HTable(conf, Bytes.toBytes(tableName));// HTabel负责跟记录相关的操作如增删改查等//  
                                                                    // 获取表  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        // 创建表  
        String tableName = "cg_blog2";  
//        tableName  = "unitappcount";
